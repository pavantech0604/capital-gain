              ...
              {PLANS.map((plan) => {
                ...
                return (
                  <StaggerItem key={plan.id}>
                    <div
                      className={`p-8 rounded-3xl flex flex-col h-full transition-all duration-300 relative ${isPopular
                    ...
                    >
                      ...
                      <Link
                        ...
                        className={`w-full py-4 rounded-xl text-headline-md font-bold text-center block transition-all ${isPopular
